...
public interface SqlOperaction {
   ...
   * @return
   */
  default   <T> Future<RowSet<T>> queryNoPager(SqlClient client, Map<String, Object> parameters , RowMapper<T> t,String querySql){
   ...
   * @return
   */
  default   <T> Future<Pager> queryDevicePager(SqlClient client, Map<String, Object> parameters,String querySql ){
    Promise promise=Promise.promise();
